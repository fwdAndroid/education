...
//Quiz
final Map<int, Map<String, dynamic>> chapterQuizzes = {
  1: {
    'question': 'What Flutter widget is best for creating scrollable lists?',
    'options': ['GridView', 'ListView', 'Container', 'Stack'],
    'correctAnswer': 'ListView',
  },
  2: {
    'question': 'Which package is used for local SQLite storage in Flutter?',
    'options': ['http', 'sqflite', 'path_provider', 'provider'],
    'correctAnswer': 'sqflite',
  },
  3: {
    'question': 'What method decrypts image data at runtime?',
    'options': ['decryptMemory', 'decodeImage', 'decryptAsset', 'decryptFile'],
    'correctAnswer': 'decryptMemory',
  },
  4: {
    'question': 'Which command obfuscates Flutter release build?',
    'options': [
      'flutter compile',
      'flutter upgrade',
    ...
    'correctAnswer': 'flutter build apk --obfuscate',
  },
  5: {
    'question': 'Which API is used for crash reporting in Flutter?',
    'options': [
      'firebase_analytics',
    ...
    'correctAnswer': 'firebase_crashlytics',
  },
};
